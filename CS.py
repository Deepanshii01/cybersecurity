...
def sbi_case_study():
   ...
   importance = """
    - <span style='color: orange;'><strong>Data Protection:</strong></span> Banks handle vast amounts of sensitive customer data, which must be safeguarded from breaches and unauthorized access.
    - <span style='color: orange;'><strong>Secure Transactions:</strong></span> Robust cybersecurity measures are essential to prevent disruptions and ensure the integrity of financial transactions.
    - <span style='color: orange;'><strong>Regulatory Compliance:</strong></span> Banks must comply with strict cybersecurity regulations to avoid penalties and reputational damage.
    - <span style='color: orange;'><strong>Preventing Cyber Attacks:</strong></span> Banks are prime targets for cybercriminals, and effective cybersecurity is crucial to mitigate the risks of cyberattacks.
...
def main():
    with st.sidebar:
        ...
        selected = option_menu(
            ...
            options=["Home", "What is Ethics?", "Key Aspects", "Data Privacy", "SBI Case Study","Case Studies","Leaderboard"],
